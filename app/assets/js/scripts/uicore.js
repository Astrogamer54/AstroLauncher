        ...
        switch(arg){
            ...
            case 'update-available':
                ...
                if(process.platform === 'darwin'){
                    info.darwindownload = `https://github.com/Astrogamer54/AstroLauncher/releases/download/v${info.version}/helioslauncher-setup-${info.version}${process.arch === 'arm64' ? '-arm64' : ''}.dmg`
                    showUpdateUI(info)
                }
